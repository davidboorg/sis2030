...
**Idag (standardiseringsspråk):**
- "ISO-kompatibel rapportering"
- "8 miljöindikatorer enligt ISO-standarder"
- "Cradle-to-gate analys"

**Nytt (företagarspråk):**
- "Miljödeklaration som kunderna kräver - klar på 10 minuter"
- "Allt dina kunder vill veta om din produkts klimatpåverkan"
- "Från råmaterial till färdig produkt - automatiskt beräknat"

Förslag ny hero-text:
...
| Mall | Typprodukt | Förfyllda komponenter |
|------|-----------|----------------------|
| Möbeltillverkare | Kontorsstol | Stål, skum, textil, plast |
| Livsmedelsproducent | Förpackat livsmedel | Kartong, plast, aluminium |
| Verkstad/metall | Bearbetad detalj | Stål, aluminium, ytbehandling |
| Bygg & fastighet | Byggelement | Betong, stål, isolering |
| Textil | Plagg | Bomull, polyester, färgning |
...
│                        │                            │
│  Ledtid: 6 veckor      │  Ledtid: 10 minuter        │
│                        │                            │
│  1 produkt/år          │  Obegränsat antal           │
│                        │  produkter                  │
│                        │                            │
│  ÅRSKOSTNAD: 200,000+  │  ÅRSKOSTNAD: 24,000        │
│                        │  BESPARING: 176,000 kr/år   │
└─────────────────────────────────────────────────────┘
```
...
**Nivå 3 - Regulatorisk beredskap (trygghet)**

- CSRD och ESRS kommer att ställa krav nedåt i leverantörskedjan
...
Detta kort kan:
- Bifogas anbud och offerter
- Publiceras på företagets hemsida
...
SFS har 97% SME bland sina medlemmar. Ändå når inte budskapet ut.

### Föreslagen förändring

#### A) Partnerskap med branschorganisationer - inte NSB-kanalen

SME-bolag litar på sin branschorganisation, inte på standardiseringsorgan. Gå via:

| Bransch | Organisation | Potentiell approach |
|---------|-------------|-------------------|
| Möbler | TMF (Trä- och Möbelföretagen) | Pilotprojekt med 5 medlemsföretag |
| Livsmedel | Livsmedelsföretagen | Webinar: "Miljödata som öppnar hyllplatser" |
| Verkstad | Teknikföretagen | Integration i deras hållbarhetsguide |
...
Nuvarande prissättning (2,000 kr/mån) är för hög som ingångspris. Inför:

| Nivå | Pris | Inkluderar |
|------|------|-----------|
| **Gratis** | 0 kr | 1 produkt, grundläggande resultat, ingen export |
| **Starter** | 500 kr/mån | 5 produkter, PDF-export, hållbarhetsbevis |
| **Pro** | 2,000 kr/mån | Obegränsat, AI-rekommendationer, API, prioriterad support |
| **Enterprise** | Offert | Multi-site, integrationer, dedikerad kontaktperson |

Gratisversionen fungerar som marknadsföringskanal - varje SME som provar blir en potentiell betalande kund och ambassadör.

#### C) Eventdriven lansering - "Meeting Standards" november 2026

Mötesanteckningarna nämner "Meeting Standards"-eventet 17-21 november med SME som målgrupp. Perfekt tillfälle att:
...
Mötesanteckningarna tar upp fördelarna med att *"utse en kontaktperson för underrepresenterade intressenter, så som exempelvis SME"*. Gör detta konkret:

- **Titel:** SME Engagement Lead
- **Uppdrag:** Vara synlig i branschorganisationers forum, LinkedIn, och lokala företagarnätverk
- **Mätetal:** Antal SME som registrerar sig, antal genomförda analyser, NPS
- **Inte:** En standardiseringstekniker. Ska vara en person som pratar affärsspråk.
...
- Månatligt drop-in-webinar: "Fråga oss om hållbarhetsdata" (30 min)
- Community-kanal (Slack/Teams) där SME kan hjälpa varandra
...
## Prioriterad handlingsplan (april-deadline)
...
- Lansera på "Meeting Standards"-eventet
- Öppna freemium-modellen brett
- Dela resultat med CEN/CENELEC som Guide 17-pilotexempel
- Bygga SME-community
...
Det här projektet har rätt teknisk grund. Det som saknas är inte fler ISO-nummer eller fler funktioner - det som saknas är **berättelsen som får en företagare i Tibro att tänka "det där är till för mig"**.

Skiftet handlar om att gå från:
- "Vi digitaliserar standarder" → **"Vi hjälper dig vinna affärer"**
- "8 miljöindikatorer" → **"Svaret din kund väntar på"**
